...
// Printer name
#define CUSTOM_MENDEL_NAME "LGX-SM-HT MK3S"
...
#define UNLOAD_FILAMENT_1 "G1 E-30 F7000"
...
#define FILAMENTCHANGE_FIRSTFEED 5 //E distance in mm for fast filament loading sequence used used in filament change (M600)
